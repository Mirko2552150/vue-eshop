...
// // ->middleware('auth')
// ->group(function() {
//     Route::resource('products' , 'UprController');
...
// Route::post('upr/checkout/{products}', 'Upr\UprController@checkout')->name('upr.products.checkout');
// Route::post('/checkout', 'Upr\UprController@checkout')->name('upr.products.checkout');
