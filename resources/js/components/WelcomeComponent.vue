        ...
        <transition class="fade">
            <div class="mask-overlay" @click="isOpen = !isOpen">
                <div class="panel" @click.stop>
                    <!-- STAMPO THIS PRODUCT NELLA VIEW -->
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            axios({
                "method": "GET",
                "url": "api/products", // chiediamo i dati con GET all API
            }).then((response) => {
                // console.log(response);
                this.products = response.data; // RICEVO NEL RESPONSE TUTTI I PRODOTTI PRESENTI NEL DB e lo assegbo alla VAR products
                // console.log(this.products[0].description);

            }).catch((error) => {
                console.log('APi ' + errorWELCOMECOMPONENT)
            });
        },
        methods: {
            getThisProduct(item) {
