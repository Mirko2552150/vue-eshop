    ...
    <div class="container">
            <div class="row">
                <div class="col-12">
                    <table class="table">
                        <tr>
                            <td><a class="btn btn-primary" href="{{route('admin.products.create')}}"> Inserisci nuovo prodotto</a></td>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <!-- RICEVO LA VAR PRODOTTI DAL CONTROLLER AUTH INDEX CHE SI INTERFACCIA CON IL BD -->
